...
def get_naver_token():
    ...
    driver.get('https://nid.naver.com/nidlogin.login', headers=headers)

    #driver.find_element_by_name('id').send_keys(naver_id)
    #driver.find_element_by_name('pw').send_keys(naver_pw)
    #driver.find_element_by_xpath('//*[@id="frmNIDLogin"]/fieldset/input').click()
    exid = "document.getElementsByTagName('id').value = '" + naver_id + "'"
    expw = "document.getElementsByTagName('pw').value = '" + naver_pw + "'"
